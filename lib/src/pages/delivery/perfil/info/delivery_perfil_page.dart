...
class DeliveryPerfilPage extends StatelessWidget {

  DeliveryPerfilController con = Get.put(DeliveryPerfilController());
  ...
  Widget _btnUpdate(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () => con.goToUpdateDeliveryPerfil(),
  ...
  Widget _btnUpdatePassword(BuildContext context) {
    return Container(
      ...
      color: Color(0xFFF2C447),
      child: ElevatedButton(
        onPressed: () => con.goToUpdateDeliveryContrasenia(),
        style: ElevatedButton.styleFrom(
          padding: EdgeInsets.symmetric(vertical: 15)),
        child: const Text(
          'Cambiar contraseña',
